...
const CareSeekersPage = () => {
  ...
  const handleActionClick = (careSeekerId: number) => {
    setOpenDropdown(openDropdown === careSeekerId ? null : careSeekerId);
  };

  const handleViewProfile = (careSeekerId: number) => {
    setSelectedCareSeekerId(careSeekerId);
    setIsProfileModalOpen(true);
    setOpenDropdown(null);
  };

  const handleSendEmail = (careSeeker: any) => {
    setSelectedCareSeekerForEmail({
      id: careSeeker.id,
      name: careSeeker.fullName,
        ...
        <main className="flex-1 overflow-y-auto p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-3xl font-bold text-gray-900 mb-2">1,100</p>
              <div className="flex items-center text-green-600 text-sm">
                ...
                +120 more care seekers than last week
              </div>
            </div>
                          ...
                          {openDropdown === careSeeker.id && (
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10 border border-gray-200">
                              <div className="py-1">
                                ...
                                <button
                                  onClick={() => handleSendEmail(careSeeker)}
                                  className="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                >
                                  <svg
                                    className="w-4 h-4 mr-3 text-gray-400"
