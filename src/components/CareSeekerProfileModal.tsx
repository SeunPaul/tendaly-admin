...
const CareSeekerProfileModal: React.FC<CareSeekerProfileModalProps> = ({
  ...
  const careSeeker = {
    ...
    bio: "I'm a care seeker looking for reliable and compassionate caregivers to help with daily activities and companionship for my family members.",
    profileImage:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
    totalPayout: "$5,500.00",
    jobsPosted: 20,
    caregiversHired: 20,
    disputesRaised: 0,
    yearsOfExperience: 2,
    ...
    reviewCount: 9,
    experience:
      "I've been using care services for over 2 years to support my family's needs. I value reliability, compassion, and professional care.",
    languages: ["English"],
  ...
  const reviews = [
    ...
    },
    {
      ...
      body: "John provided exceptional care for my mother. He was always punctual, professional, and caring. Highly recommend!",
    ...
    },
    {
      ...
      body: "John has been taking care of my grandmother for months now. He's incredibly patient and understanding.",
    ...
    },
    {
      ...
      body: "Professional, caring, and always goes above and beyond. My family is very grateful for his services.",
      reviewerName: "Emily Rodriguez",
      date: "3 weeks ago",
    },
  ];

  const tabs = ["Profile Information", "User Reviews"];

  const handleEmailUser = () => {
    setIsEmailModalOpen(true);
  };
  const handleSuspendUser = () => {
    console.log(`Suspend user: ${careSeeker.id}`);
  };
  const handleDeleteUser = () => {
    console.log(`Delete user: ${careSeeker.id}`);
  };
    ...
    <>
        ...
        <div className="flex h-[85vh] overflow-hidden">
          ...
          <div className="w-1/3 bg-gray-50 p-6 rounded-l-lg overflow-y-auto">
            ...
            <div className="text-center mb-4">
              ...
              <p className="text-gray-600">{careSeeker.role}</p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={() => handleCopyToClipboard(careSeeker.phone)}
                    className="text-gray-400 hover:text-gray-600"
                  >
                    <svg
                      className="w-4 h-4"
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="flex items-center">
                          {[...Array(5)].map((_, i) => (
                            <svg
                              key={i}
                              className={`w-5 h-5 ${
                                i < Math.floor(careSeeker.rating)
                                  ? "text-red-500"
                                  : i < careSeeker.rating
                                  ? "text-red-500"
                                  : "text-gray-300"
                        ...
                        <span className="text-lg font-semibold text-gray-900">
                          {careSeeker.rating} out of 5
                        </span>
                        <span className="text-gray-500">
                          ({careSeeker.reviewCount} Reviews)
                        </span>
                      </div>
                    </div>
                ...
                <div className="bg-white p-4 rounded-lg border border-gray-200">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-medium">{careSeeker.gender}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-600">
                        Date of Birth
                      </span>
                      <p className="font-medium">{careSeeker.dateOfBirth}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-600">Country</span>
                      <p className="font-medium">{careSeeker.country}</p>
                    </div>
                    <div className="col-span-2">
                      <span className="text-sm text-gray-600">
                        Home address
                      </span>
                      <p className="font-medium">{careSeeker.address}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-600">Zip code</span>
                      <p className="font-medium">{careSeeker.zipCode}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-600">
                        Account created
                      </span>
                      <p className="font-medium">{careSeeker.accountCreated}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-600">Last active</span>
                      <p className="font-medium">{careSeeker.lastActive}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <EmailUserModal
        ...
        recipient={{
          ...
          profileImage: careSeeker.profileImage,
        }}
      />
    </>
  );
